...
declare namespace GoldenLayout {
  ...
  /**
   * Adds an item as a child to this item. If the item is already a part of
   * a layout it will be removed from its original position before adding it
   * to this item.
   *
   * @param itemOrItemConfig 	A content item (or tree of content items) or an ItemConfiguration to create the item from
   * @param index An optional index that determines at which position the new item should be added.
   */
    addChild(itemOrItemConfig: ContentItem | Config | ItemConfig, index?: number): void
